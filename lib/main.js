var dict = ["crab", "dolphin", "elephant","dog", "fish",  "flamingo", "frog", "hen", "monkey", "seal", "snake", "squid", "squirrel", "toucan", "walrus", "whale", "bee", "bison", "camel","cat","chameleon","deer","giraffe","hedgehog","hippo","horse","jellyfish","kangaroo","kiwi","koala","lion","llama","lobster","meerkat","octopus","ostrich","owl","panda","penguin","pig","rabbit","seahorse","shark","snail","swan","turtle"];
var target = 0;
var testFlag = -1;
var startFlag = 0;
var clicks = 0;
  ...
  $('#board').click(function(e){
    ...
    else if(testFlag == -1)
    {
      ...
      if(startFlag == 2)
      {
        ...
        ctx.fillText("After a random period of time, the animals will freeze and be covered up.",w/2, h/2-35);
        ctx.fillText("You will be asked to click on a specific animal.",w/2, h/2+35);
      ...
      if(startFlag == 4)
      {
        ...
        ctx.fillText("There are 30 questions in one HIT,",w/2, h/2-70);
